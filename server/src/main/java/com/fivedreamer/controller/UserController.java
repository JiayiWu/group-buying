...
public class UserController {
    ...
    /**
     * @param session
     * @return MessageInfo(True 则为获取当前用户信息成功,用户信息存储在object中.False 则为修改失败,具体失败原因存储在Reason中)
     */
     ...
     * @return MessageInfo(True 则为修改成功,成功更新后的对象存储在object中. False 则为修改失败,具体失败原因存储在Reason中)
     */
     ...
     * @return MessageInfo(True 则为修改成功,成功更新后的对象存储在object中.  False 则为修改失败,具体失败原因存储在Reason中,成功更新后的对心存储在object中)
     */
